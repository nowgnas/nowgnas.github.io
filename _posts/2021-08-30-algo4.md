...
lastmod: 2021-08-30 13:00 +0900
description: "파이썬 알고리즘 인터뷰 5장을 정리한 내용으로, 파이썬 List와 Dictionary의 시간 복잡도 및 defaultdict, Counter, OrderedDict 등의 컬렉션 모듈 활용법을 정리합니다."
categories:
  - algorithm
tags: [algorithm]
mermaid: true
