...
lastmod: 2023-07-23 16:31:07
description: "REST API의 개념과 RESTful한 API를 위한 6가지 조건(Client-Server, Stateless, Cacheable 등)을 설명하고, URI 설계 규칙과 올바른 리소스 표현 방법을 정리합니다."
tags: [rest-api, http]
categories:
  - java
permalink: /posts/rest-api-design/
---
