...
lastmod: 2021-09-14 01:48 +0900
description: "점프 투 장고를 정리한 포스트로, Django 모델 작성과 ForeignKey 관계 설정, makemigrations와 migrate 명령을 통한 데이터베이스 관리, 장고 셸에서의 CRUD 방법을 다룹니다."
categories:
  - web
tags: [web, django]
mermaid: true
